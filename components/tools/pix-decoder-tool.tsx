...
const ui: Record<string, Record<AppLocale, string>> = {
  ...
  dynamicUrlHelp: {
    ...
    zh: 'Use the domain/path provided by the PSP. If you paste https://, the tool removes the protocol.',
  },
  ...
  syncedPayload: {
    ...
    zh: 'Payload synced with validation, decoder, tree, CRC, export, and QR Code.',
  },
  ...
  zh: '100% local processing. No data is sent to any server.', },
  ...
  zh: 'A valid CRC does not mean the recipient is trustworthy. Always verify in your banking app.', },
