...
const ui = {
  ...
  zh: '🎓 Educational conversion — review before compiling.', },
  ...
  zh: '🔒 100% local. No code is sent to any server.', },
  ...
  zh: 'Classic study list (books/university)', },
  compileHint: {
    ...
    zh: 'To validate the result, use OnlineGDB (online editor/compiler) and adjust syntax details when needed.',
  },
  ...
  noExamplesFound: {
    ...
    zh: 'No examples found for this filter.',
  },
