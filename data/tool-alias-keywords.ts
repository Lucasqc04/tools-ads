...
const baseKeywordsByTool: ToolKeywordMap = {
  ...
  'data-converter': {
    'pt-br': [
      'conversor json csv xlsx',
      'converter json para csv',
      'converter csv para json',
      'converter xlsx para json',
      'converter xlsx para csv',
      'converter csv para sql insert',
      'converter sql insert para csv',
      'converter tsv para xlsx',
      'converter txt para csv',
      'conversor de planilha online',
      'json para excel online',
      'csv para excel online',
    ],
    en: [
      ...
      'convert sql insert to csv',
      'convert tsv to xlsx',
      'convert txt to csv',
      'spreadsheet converter online',
    ...
    es: [
      ...
      'convertir csv a sql insert',
      'convertir sql insert a csv',
      'convertir tsv a xlsx',
      'convertir txt a csv',
      'conversor de planilla online',
      'json a excel online',
      'csv a excel online',
    ],
  },
  ...
  'remover-fundo-imagem': {
    'pt-br': [
      ...
      'removedor de fundo sem cadastro',
      'despill imagem chroma',
    ],
    en: [
      ...
      'remove background without quality loss',
  ...
  'extrair-audio-de-video': {
    'pt-br': [
      ...
      'editor de audio com waveform',
      'extrair som de video para jogo',
      'cortar audio para jogo',
      'separar faixas de audio de video',
      'audio cutter online',
    ],
    en: [
    ...
    es: [
      ...
      'cortar audio para juego',
      'separar pistas de audio de video',
      'audio cutter online',
    ],
  },
  'qr-code-generator': {
