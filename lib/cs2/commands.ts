...
export const getCommandCategoryLabel = (category: Cs2CommandCategory, locale: AppLocale): string => {
  const labels: Record<Cs2CommandCategory, Record<AppLocale, string>> = {
    practice: { 'pt-br': 'Treino', en: 'Practice', es: 'Practica', zh: '训练' },
    round: { 'pt-br': 'Round/Tempo', en: 'Round/Time', es: 'Ronda/Tiempo', zh: '回合/时间' },
    money: { 'pt-br': 'Dinheiro/Compra', en: 'Money/Buy', es: 'Dinero/Compra', zh: '金钱/购买' },
    grenades: { 'pt-br': 'Granadas', en: 'Grenades', es: 'Granadas', zh: '投掷物' },
    smokes: { 'pt-br': 'Smokes', en: 'Smokes', es: 'Smokes', zh: 'Smokes' },
    bots: { 'pt-br': 'Bots', en: 'Bots', es: 'Bots', zh: 'Bots' },
    radar: { 'pt-br': 'Radar', en: 'Radar', es: 'Radar', zh: 'Radar' },
    hud: { 'pt-br': 'HUD', en: 'HUD', es: 'HUD', zh: 'HUD' },
    viewmodel: { 'pt-br': 'Viewmodel', en: 'Viewmodel', es: 'Viewmodel', zh: 'Viewmodel' },
    fps: { 'pt-br': 'FPS/Performance', en: 'FPS/Performance', es: 'FPS/Rendimiento', zh: 'FPS/性能' },
    audio: { 'pt-br': 'Audio/Voz', en: 'Audio/Voice', es: 'Audio/Voz', zh: '音频/语音' },
    binds: { 'pt-br': 'Binds', en: 'Binds', es: 'Binds', zh: 'Binds' },
    autoexec: { 'pt-br': 'Autoexec', en: 'Autoexec', es: 'Autoexec', zh: 'Autoexec' },
    competitive: { 'pt-br': 'Competitivo', en: 'Competitive', es: 'Competitivo', zh: '竞技' },
    fun: { 'pt-br': 'Fun/Privado', en: 'Fun/Private', es: 'Fun/Privado', zh: '娱乐/私服' },
    server: { 'pt-br': 'Servidor', en: 'Server', es: 'Servidor', zh: '服务器' },
