...
export const universalConversions: UniversalConversionDefinition[] = [
  ...
  conversion({
    ...
    labelByLocale: {
      ...
      zh: 'Text to escaped JSON string',
    },
  ...
  conversion({
    ...
    labelByLocale: {
      ...
      zh: 'Escaped JSON string to text',
    },
  ...
  conversion({
    ...
    labelByLocale: {
      ...
      zh: 'Remove invisible characters',
    },
...
export const universalPresets: UniversalPreset[] = [
  {
    ...
    warningByLocale: {
      ...
      zh: 'Hashes are not reversible by design.',
    },
  },
  {
    id: 'all-encodings',
  ...
  },
  {
    ...
    warningByLocale: {
      ...
      zh: 'Classic ciphers are educational and not modern encryption.',
    },
  },
  {
