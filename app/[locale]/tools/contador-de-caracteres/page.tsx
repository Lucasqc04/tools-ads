...
const toolSlug = 'contador-de-caracteres';

type CharacterCounterPageProps = Readonly<{
  params: Promise<{
    locale: string;
  }>;
}>;
...
export async function generateMetadata({
  params,
}: CharacterCounterPageProps): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({
    ...
    localePaths: buildLocalePathMap('/tools/contador-de-caracteres'),
    keywords: tool
  ...
  return (
    <>
      ...
      <ToolPageShell
        ...
        toolUi={<CharacterCounterTool locale={locale} />}
      />
    </>
  );
}
