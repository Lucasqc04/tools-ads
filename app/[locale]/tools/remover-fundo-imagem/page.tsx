...
const toolSlug = 'remover-fundo-imagem';

type BackgroundRemoverPageProps = Readonly<{
  params: Promise<{
    locale: string;
  }>;
}>;
...
export async function generateMetadata({
  params,
}: BackgroundRemoverPageProps): Promise<Metadata> {
  ...
  return buildLocalizedMetadata({
    ...
    localePaths: buildLocalePathMap('/tools/remover-fundo-imagem'),
    keywords: tool
  ...
  return (
    <>
      ...
      <ToolPageShell
        ...
        toolUi={<ChromaBackgroundRemoverTool locale={locale} />}
      />
    </>
  );
}
